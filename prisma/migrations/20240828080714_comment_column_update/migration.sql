/*
  ...
  - You are about to drop the column `commnet` on the `Response` table. All the data in the column will be lost.
  - Added the required column `comment` to the `Response` table without a default value. This is not possible if the table is not empty.
